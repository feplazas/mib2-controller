...
const PREDEFINED_PROFILES: VIDPIDProfile[] = [
  ...
  },
  {
    ...
    vendorId: 0x0424,
    productId: 0x9500,
    chipset: 'SMSC LAN9500',
    category: 'mib2_compatible',
    compatible: true,
    notes: 'SMSC LAN9500 - Compatible con MIB2 como dispositivo de desarrollo VAG.',
    icon: '✅',
  },
  {
    id: 'germaneers_lan9514',
    name: 'Germaneers LAN9514',
    manufacturer: 'Germaneers',
    model: 'LAN9514',
    vendorId: 0x2721,
    productId: 0xEC00,
    chipset: 'Microchip LAN9514',
    category: 'mib2_compatible',
    compatible: true,
    notes: 'Germaneers LAN9514 - Compatible con MIB2 como dispositivo de desarrollo VAG.',
    icon: '✅',
  },
  {
    id: 'cinterion_ah6a',
    name: 'Cinterion AH6A 3G',
    manufacturer: 'Cinterion/Gemalto',
    model: 'AH6A 3G',
    vendorId: 0x1E2D,
    productId: 0x0055,
    ...
    category: 'mib2_compatible',
    compatible: true,
    notes: 'Cinterion AH6A 3G - Compatible con MIB2 como dispositivo de desarrollo VAG.',
    icon: '✅',
  },
  {
    id: 'cinterion_als',
    name: 'Cinterion ALS1/ALS6',
    manufacturer: 'Cinterion/Gemalto',
    model: 'ALS1/ALS6',
    vendorId: 0x1E2D,
    productId: 0x0060,
    ...
    category: 'mib2_compatible',
    compatible: true,
    notes: 'Cinterion ALS1/ALS6 - Compatible con MIB2 como dispositivo de desarrollo VAG.',
    icon: '✅',
  },
