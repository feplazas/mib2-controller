...
export const ADAPTER_DATABASE: AdapterSpec[] = [
  ...
  // ========== MIB2 VAG Whitelisted Devices ==========
  {
    vendorId: 0x0424,
    productId: 0x9500,
    vendorName: 'SMSC/Microchip',
    productName: 'SMSC LAN9500 USB 2.0 to Fast Ethernet',
    chipset: 'LAN9500',
    chipsetFamily: 'Microchip',
    eepromType: '93C56',
    eepromSize: 256,
    eepromOffsets: {
      vidLow: 0x00,
    ...
    spoofingCompatibility: 'incompatible',
    mib2Whitelisted: true,
    notes: 'SMSC LAN9500 - VAG developer tool. Whitelisted by MIB2.',
  },
  {
    vendorId: 0x2721,
    productId: 0xEC00,
    vendorName: 'Germaneers',
    productName: 'Germaneers LAN9514 USB Hub + Ethernet',
    chipset: 'LAN9514',
    chipsetFamily: 'Microchip',
    eepromType: '93C56',
    eepromSize: 256,
    ...
    spoofingCompatibility: 'incompatible',
    mib2Whitelisted: true,
    notes: 'Germaneers LAN9514 - VAG developer tool. Whitelisted by MIB2.',
  },
  {
    vendorId: 0x1E2D,
    productId: 0x0055,
    vendorName: 'Cinterion/Gemalto',
    productName: 'Cinterion AH6A 3G Modem',
    chipset: 'Cinterion AH6A',
    chipsetFamily: 'Other',
    eepromType: 'Unknown',
    eepromSize: 0,
    eepromOffsets: {
    ...
    spoofingCompatibility: 'incompatible',
    mib2Whitelisted: true,
    notes: 'Cinterion AH6A 3G - VAG developer tool. Whitelisted by MIB2.',
  },
  {
    vendorId: 0x1E2D,
    productId: 0x0060,
    vendorName: 'Cinterion/Gemalto',
    productName: 'Cinterion ALS1/ALS6 Modem',
    chipset: 'Cinterion ALS',
    chipsetFamily: 'Other',
    eepromType: 'Unknown',
    eepromSize: 0,
    eepromOffsets: {
    ...
    spoofingCompatibility: 'incompatible',
    mib2Whitelisted: true,
    notes: 'Cinterion ALS1/ALS6 - VAG developer tool. Whitelisted by MIB2.',
  },
